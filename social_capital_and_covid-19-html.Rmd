...
```{r table-1, results='asis', eval=FALSE}
df %>%
  select(
    cases_new,
...
To provide further support for these results, Table 3 shows corresponding evidence for Figure 1. That is, Table 3 shows the change in daily, new COVID-19 cases in states based on whether they have a high or low desire for prevention and whether they have a strong or weak level of social capital. Using specification 2, 

analyze the subcomponents of social capital to see if any are more or less relevant

Further, given the higher F-statistic in column 3, we perceive that this model picks up as much of the cross-sectional variation as column 2 and allows us to estimate the impact of social capital independent of the covariates.
