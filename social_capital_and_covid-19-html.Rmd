...
An instrumental variables regression---found in column 4---suggests that specification 3 with the reported control variables as *covariates* is a more robust specification than if they were included as instruments. Given the relatively larger magnitudes of our two social capital variables, the included instruments are likely correlated with the error term of the daily new cases per million equation. 
...
Table 4 re-estimates equation 2 of Table 2 with alternative measures of social capital from the existing literature. These measures include: SCP version of Penn State Index (2014), the Putnam Index (2000), and the Alesina & La Ferrara social capital group (2000), reported in columns 2, 3, 4, respectively. All of these measures were taken from the JEC Social Capital Project. Our main results are consistent in sign and statistical significance across these measures of social capital. 
