...
The sign, magnitude, and statistical significance of our main variables of interest remain remarkably similar across all three specifications. This suggests stringency, social capital, and the interaction of stringency and social capital are important factors that influence the spread of COVID-19. Our results do not differ in a qualitative sense as we control for two-way fixed effects (in specification 2) and relevant, observable proxies (in specification 3).

To provide further support for the framework, Table 4 shows by how much new COVID-19 cases change within a state based on whether they have a high or low desire for prevention and whether they have a strong or weak level of social capital. Using specification 2---our preferred specification---we find that states with a higher value of prevention and a higher level of social capital reduce new daily cases by 210 per million. 
