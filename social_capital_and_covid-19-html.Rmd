...
```{=tex}
\begin{align}
\mathit{New Cases_{i,t}} = \beta_0 + \beta_1\mathit{Stringency}_{i,t-7} +\beta_2\mathit{Stringency}_{i,t-7}^{2} +\beta_3\mathit{Sringency_{i,t-7}} \times \mathit{SocialCapital_{i,t}} + \epsilon_{i,t}
\end{align}
```
