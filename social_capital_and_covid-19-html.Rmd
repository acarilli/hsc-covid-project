...
+------------------------------+------------------------------------------------+-------------------------------------------------------+
| **Low Value on Prevention**  | | III - Prevalence rates fall | | IV - Prevalence rates rise the most |
+------------------------------+------------------------------------------------+-------------------------------------------------------+
...
```{=tex}
\begin{align}
\mathit{New Cases_{it}} = \beta_0 + \beta_1\mathit{Stringency}_{it-7} +\beta_2\mathit{Stringency}_{it-7}^{2} +\beta_3\mathit{Sringency_{it-7}} \times \mathit{SocialCapital_{it}} + \epsilon_{it}
\end{align}
```
...
To clarify the meaning of our results, Table 4 uses specification 2 of Table 3 to show by how much new COVID-19 cases change given a state has a high or low desire for prevention---measured at the first, second, and third quartiles---and whether a state has a strong or weak level of social capital---measured at the mean and one and two standard deviations above and below the mean. Once again Table 4 supports our propositions, especially 1 and 3.^[Specification 2 drops the social capital measure as it does not vary over time.] The whole numbers in Table 4 represent deviations away from the average desire for prevention and the average level of social capital. 
