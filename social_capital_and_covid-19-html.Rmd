...
The first column in Table 3 provides the empirical results of equation 1 and supports our initial propositions. A one unit increase in the level of daily stringency, which we suggest is indicative of the values people have for disease prevention, reduces new cases by 4.48 per million. States with a higher level of social capital add 26 new cases per million.
...
To clarify the meaning of our results, Table 4 uses specification 2 of Table 3---our preferred specification---to show by how much new COVID-19 cases change given a state has a high or low desire for prevention---measured at the first, second, and third quartiles---and whether a state has a strong or weak level of social capital---measured at the mean and one and two standard deviations above and below the mean. Once again Table 4 supports our propositions, especially 1 and 3.^[Specification 2 drops the social capital measure as it does not vary over time.] States with a higher value for prevention experienced a larger reduction in new cases; states with a higher value for prevention *and* stronger social capital experienced an even larger reduction in new cases. That is, states with a high value of prevention and a strong level of social capital reduce new daily cases by 210 per million. That is, given the estimated coefficients in specification 2 of Table 3 and assuming a state places a high value on COVID-19 prevention and a strong level of social capital, they experienced 210 fewer new, daily COVID-19 cases. Similarly, states with the lowest value on COVID-19 prevention and the weakest level of social capital experienced 68.9 fewer new COVID-19 cases.
...
We prefer specification 2 (over specification 1 and 3) because it is more parsimonious. As it includes time and place fixed effects, which accounts for all of the unobserved variation in new, daily cases. Specification 3 only accounts for the variables we can observe and included. Further, given the higher F-statistic in column 3, we perceive that this model picks up as much of the cross-sectional variation as column 2 and allows us to estimate the impact of social capital independent of the covariates.
