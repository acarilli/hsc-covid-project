...
author: 
  - Byron Carson, III^[Hampden-Sydney College, bcarson@hsc.edu]
  - Justin Isaacs^[Hampden-Sydney College, jisaacs@hsc.edu]
  - Anthony Carilli^[Hampden-Sydney College, tcarilli@hsc.edu]
output:
...
1.  People that place a higher value on COVID-19 prevention will have larger effects on the growth of COVID-19 cases than people that do not value COVID-19 prevention, all else equal.
...
Column 3 of Table 3---the two-way fixed effects specification---shows similar results. A higher level of stringency decreases new cases by 3.94 per million and the social capital and stringency interaction term lowers new cases by an additional .568 per million. Unfortunately, column 3 requires us to drop our time-invariant social capital dummy variables to account for the cross-sectional variation.
...
To clarify the meaning of our results, Table 4 shows the change in daily, new cases using specification 3 of Table 3 across different levels of social capital and the desire for prevention relative to the typical values of each. We measure high and low prevention at the first, second, and third quartiles, and we measure strong and weak social capital at two standard deviations above and below the mean. Once again Table 4 supports our propositions, especially 1 and 3.[^7] The whole numbers in Table 4 represent deviations away from the typical desire for prevention and the typical level of social capital, and the typical state shows no change in daily, new cases.

[^7]: Specification 3 drops the social capital measure as it does not vary over time.
...
States with a higher value for prevention (relative to the average value of prevention) experienced a larger reduction in new cases; states with a lower value for prevention (relative to the average value of prevention) mostly experienced additional new cases. States with a higher value of prevention *and* a stronger level of social capital experienced the largest reduction in new daily cases per million. That is, these states experienced approximately 81 fewer new cases relative to states with an average desire for prevention and the average level of social capital. States with a lower value of prevention and a lower level of social capital experienced 60 additional cases per million.
...
[^8]: Further, specification 3 is more parsimonious as it includes time and place fixed effects, which accounts for the unobservable cross-sectional variation; specification 2 only accounts for the variables we can observe and included.
