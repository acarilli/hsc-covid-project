...
df %>% 
  ...
  labs(x = "Social Capital", y = "Median Lagged Stringency")  +
  theme_classic() +
  theme(legend.position = c(0.25,.10), 
        legend.direction = "horizontal", 
        legend.title = element_blank()) +
  ggtitle("Median Daily New Cases per Million") +
  annotate(geom = "text", x = -1.70, y = 55, label = "Median Level of Stringency") +
